    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">LHLDS Admin <sup>2</sup></div>
            </a>
            ...
            <div class="sidebar-card">
                ...
                <p class="text-center mb-2"><strong>Lesotho Housing for everyone...</strong> more features, components, and more!</p>
                <a class="btn btn-success btn-sm" href="{{ route('home') }}">Go to shopping!</a>
            </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Lesotho Housing</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
